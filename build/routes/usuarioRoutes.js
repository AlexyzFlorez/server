...
class UsuarioRoutes {
    ...
    configuracion() {
        ...
        this.router.get('/obtener-eventos/:idActividad', usuarioController_1.usuarioController.obtenerEventos);
        this.router.get('/obtener-detalles-evento/:id', usuarioController_1.usuarioController.obtenerDetallesEvento);
        //Calendario
        this.router.get('/obtener-eventos-calendario', usuarioController_1.usuarioController.obtenerEventosCalendario);
    }
}
